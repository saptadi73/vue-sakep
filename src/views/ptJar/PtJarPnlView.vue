...
import { fetchJarProfitLoss } from '@/services/jabMartService'
...
const loadReport = async () => {
  ...
  const result = await fetchJarProfitLoss(params)
...
const exportReport = () => {
  ...
  exportMultiSheetExcel(
    ...
    `PTJAR_ProfitLoss_${selectedMonth.value}_${selectedYear.value}`,
  )
}
</script>
...
<template>
  <section class="report-page">
    <header class="report-header">
      ...
      <p class="sub">Laporan laba rugi untuk kebutuhan konsolidasi SAK EP.</p>
    ...
    <ReportTable
      ...
      empty-message="Data laporan laba rugi belum tersedia."
